...
public class SpringSecurityConfig {
    ...
    public SecurityWebFilterChain configure(ServerHttpSecurity http){
        return http.authorizeExchange()
                ...
                .pathMatchers(HttpMethod.POST,"/api/usuarios", "/api/usuarios/resetPassword", "/api/usuarios/resetPassword", "/api/consulta/twilio/**").permitAll()
    ...
    CorsConfigurationSource corsConfiguration() {
        ...
        corsConfig.setAllowedOrigins(Arrays.asList(FRONTEND_LOCALHOST, FRONTEND_STAGING, "http://35.247.228.233"));
