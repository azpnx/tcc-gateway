...
public class SpringSecurityConfig {
    ...
    public SecurityWebFilterChain configure(ServerHttpSecurity http){
        return http.authorizeExchange()
                ...
                .pathMatchers(HttpMethod.POST,"/api/usuarios", "/api/usuarios/resetPassword", "/api/usuarios/resetPassword", "/api/consulta/twilio/room", "/api/consulta/twilio/token", "/api/consulta/twilio/**").permitAll()
